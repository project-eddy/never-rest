...
See [specs/cause-chaining.md](../specs/cause-chaining.md) (`src/error.test.ts`, `src/server/serve.test.ts`) and [specs/graded-disclosure.md](../specs/graded-disclosure.md) (`src/disclose.test.ts`, `src/server/serve.test.ts`).
