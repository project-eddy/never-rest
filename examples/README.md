...
| [`next-app-router`](next-app-router) | Next.js App Router | 3003 | `handler.ts` + catch-all `/api/*` with `basePath: '/api'` |
| [`sveltekit`](sveltekit) | SvelteKit | 3004 | `handler.ts` + cooperative `handle()` in `hooks.server.ts` |
