...
| [contract-compilation.spec.md](./contract-compilation.spec.md) | `compileContract`, `assertHandlersComplete`, `matchPath` decode, `isContractPath` — duplicate matchers, trailing slashes, handler completeness, host path membership |
...
| Unit | `compileContract`, `matchPath`, `assertHandlersComplete`, `isContractPath` | `contract-compilation.spec.md` |
